        ...
        {emailSubmitted ? (
          ...
          <form className="flex flex-col" onSubmit={handleSubmit}>
            <div className="mb-6">
              ...
              <input name="email" type="email" id="email" required className="bg-[#18191E] border border-[#33353F] placeholder-[#9CA2A9] text-gray-100 text-sm rounded-lg block w-full p-2.5" placeholder="galang@gmail.com" />
            </div>
            <div className="mb-6">
            ...
            <button type="submit" className="bg-purple-700 hover:bg-purple-800 text-white font-medium py-2.5 px-5 rounded-lg w-full">
              Send Message
            </button>
          </form>
        )}
